...
def display_next_steps() -> None:
    ...
    print("\n" + "=" * 70)
    print(f"✅ Project '{project_slug}' initialized successfully!")
    print("=" * 70)
    
    print("\n📦 Generated Files:")
    print(f"  ✓ {project_slug}/project.yaml     - Project configuration")
    print(f"  ✓ {project_slug}/Taskfile.yml     - Task automation")
    print(f"  ✓ {project_slug}/README.md        - Quick start guide")
    print(f"  ✓ {project_slug}/.gitignore       - Git ignore patterns")
    
    print("\n🚀 Next Steps:")
    print(f"\n  1️⃣  Enter your project directory:")
    print(f"      cd {project_slug}")
    
    print("\n  2️⃣  Generate full project structure using Docker:")
    print("      task generate")
    ...
    print("\n  5️⃣  Run compliance checks:")
    print("      task compliance")
    
    print("\n  6️⃣  (Optional) Initialize Git repository:")
    print("      git init")
    print("      git add .")
    ...
    print("  • Taskfile.yml      - Available tasks (run 'task -l')")
    print("  • project.yaml      - Customize features and settings")
    
    print("\n💡 Tips:")
    print("  • Edit project.yaml to enable/disable features")
    print("  • Run 'task generate' again after changing project.yaml")
    print("  • Use 'task -l' to see all available tasks")
    print(f"  • Update templates: docker pull {scaffold_image}")
